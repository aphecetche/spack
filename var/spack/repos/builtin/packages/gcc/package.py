...
class Gcc(AutotoolsPackage, GNUMirrorPackage):
    ...
    if sys.platform == 'darwin' and platform.machine() == 'arm64':
        version('11.2.0','d7f8af7a0d9159db2ee3c59ffb335025a3d42547784bee321d58f2b4712ca5fd',url='https://github.com/fxcoudert/gcc/archive/refs/tags/gcc-11.2.0-arm-20211124.tar.gz')
    else:
